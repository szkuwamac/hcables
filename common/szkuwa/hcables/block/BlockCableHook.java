...
public class BlockCableHook extends Block implements ITileEntityProvider {

	public static BlockCableHook create() {
		BlockCableHook item = new BlockCableHook(Material.glass);
		item.init();
		return item;
	}
	...
	public int getLightValue(IBlockAccess world, int x, int y, int z){
		...
		if (tech != null){
			//System.out.println("Getting light value [" + x + "," + y + "," + z + "] running:" + tech.isRunning());
			if (tech.isRunning()){
				return 15;
			} else {
				return 0;
